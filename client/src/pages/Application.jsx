                ...
                <div className='flex gap-2 mb-6 mt-3'>
                    {
                        ...
                        <>
                            <label className='flex items-center' htmlFor="resumeUpload">
                                ...
                                <input  id='resumeUpload' onChange={e => setResume(e.target.files[0])} accept='application/pdf' type="file" name="" hidden  />
                            ...
                            jobsApplied.map((job) => (
                                (true) ? (
                                    <tr>
                                        ...
                                        <td className='py-2px-4 border-b'>{job.title}</td>
                                        <td className='py-2px-4 border-b max-sm:hidden'>{job.location}</td>
                                        <td className='py-2px-4 border-b max-sm:hidden'>{moment(job.date).format('ll')}</td>
                                        <td className='py-2px-4 border-b'>
